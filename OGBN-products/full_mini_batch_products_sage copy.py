	...
	for run in range(args.num_runs):
		...
		for epoch in range(args.num_epochs):
			...
			if epoch >= args.log_indent:
				...
				print('Training time/epoch {}'.format(tmp_t2-t0-time_extra))
				print('Training time without block to device /epoch {}'.format(tmp_t2-time_extra-sum(block_to_t)))
