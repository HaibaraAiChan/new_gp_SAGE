	...
	for run in range(args.num_runs):
		...
		for epoch in range(args.num_epochs):
			...
			if epoch >= args.log_indent:
				...
				time_block_gen.append(time.time() - t0 - load_pickle_t)
			...
			if epoch >= args.log_indent:
				...
				print('Average training time/epoch {}'.format(np.mean(dur)))
				
				print('Average Training time/epoch w/o nid counting {}'.format(tte-tmp_t-time_ex))
