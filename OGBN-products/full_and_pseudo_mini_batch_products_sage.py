...
def main():
	...
	# argparser.add_argument('--re-partition-method', type=str, default='shared_neighbor_graph_partition_s0')
	# argparser.add_argument('--selection-method', type=str, default='shared_neighbor_graph_partition_s1')
	argparser.add_argument('--num-re-partition', type=int, default=1) # 1 will enter m-split, 0 will not
	#-------------------------------------------------------------------------------------------------------
