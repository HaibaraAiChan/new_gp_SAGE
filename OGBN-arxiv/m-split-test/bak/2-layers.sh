                                ...
                                do
                                        ...
                                        do
                                                ...
                                                do
                                                        ...
                                                        &> ${savePath}/${Aggre}/no_drop_edges/re-random-2/${Data}_${Aggre}_l_${layers}_fo_${fan_out}_nb_${nb}_${pMethodSub}_re_${re_partition_method}.log
